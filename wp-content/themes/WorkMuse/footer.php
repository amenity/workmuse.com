			...
			<div id="footer">
				<div class="row" role="contentinfo">
					...
					<div class="smallPrint twelve columns">
						...
						<p><a href="<?php echo esc_url( __( 'http://wordpress.org/', 'eyelikedesign' ) ); ?>" title="<?php esc_attr_e( 'Semantic Personal Publishing Platform', 'eyelikedesign' ); ?>" rel="generator"><?php printf( __( 'Powered by %s', 'eyelikedesign' ), 'WordPress.' ); ?></a></p>
					</div>
					<div class="eight columns">
