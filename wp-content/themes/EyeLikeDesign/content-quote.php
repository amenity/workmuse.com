...
?>
	...
	<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
		<div class="entry-meta">
			...
			<span class="label radius secondary"><a href="<?php the_permalink(); ?>" title="<?php printf( esc_attr__( 'Permalink to %s', 'eyelikedesign' ), the_title_attribute( 'echo=0' ) ); ?>" rel="bookmark"><?php _ex( 'Quote', 'Post format title', 'eyelikedesign' ); ?></a></span>
		</div>
