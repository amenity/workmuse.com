 ...
 * @return void
 */
function eyelikedesign_load_scripts() {

	// register eld-foundation.min.js
	wp_register_script(
        'foundation-js', //handle
        get_template_directory_uri() . '/javascripts/eld-foundation.min.js', //source
    ...
    wp_register_script(
        ...
        eyelikedesign_get_theme_version(),
        true
	);
    ...
    wp_register_style(
        'eld-foundation-css', //handle
        get_stylesheet_uri(),
        array( 'foundation-css' ),
        eyelikedesign_get_theme_version() //version
    );
    ...
    wp_enqueue_style( 'eld-foundation-css' );

}
add_action( 'wp_enqueue_scripts', 'eyelikedesign_load_scripts' );