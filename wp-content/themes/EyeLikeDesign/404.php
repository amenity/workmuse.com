			...
			<div class="post-box">
				...
				<article id="post-0" class="post error404 not-found">
					<header class="entry-header">
						<h1 class="entry-title"><?php _e( '404 &ndash; What have you done? You broke the internet!', 'eyelikedesign' ); ?></h1>
					</header>
					...
					<div class="entry-content">
						<div class="row">
							<div class="twelve columns">
								<div class="panel">
									<p class="lead"><?php _e( 'The page you are looking for is gone. Perhaps searching or one of the links below will get you back on track.', 'eyelikedesign' ); ?></p>
									<?php get_search_form(); ?>
								</div>
							</div>
						</div>
						<div class="row">
							...
							<div class="four columns">
								<div class="widget">
									<h4 class="widgettitle"><?php _e( 'Most Used Categories', 'eyelikedesign' ); ?></h4>
									<ul>
							...
							<div class="four columns">
								<?php
									$archive_content = '<p>' . __( 'Try looking in the monthly archives.', 'eyelikedesign' ) . '</p>';
